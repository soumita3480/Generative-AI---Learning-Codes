...
class review (BaseModel):
    summary: str=Field(description='give brief infomation of the text passed to you')
    sentiment: str=Field(description="give the sentiment as positive or negative or neutral")
